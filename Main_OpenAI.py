...
if collection.count_documents({}) == 0:
    print("Populating MongoDB collection with documents...")
    manual_docs = [
        Document(page_content="High vibration and high bearing temperature indicate bearing failure.", metadata={"doc_id": "doc_1"}),
        Document(page_content="Low discharge pressure can be caused by worn bearings.", metadata={"doc_id": "doc_2"}),
        Document(page_content="Excessive noise and shaft misalignment can lead to premature bearing wear.", metadata={"doc_id": "doc_3"}),
        Document(page_content="High motor current may indicate pump overloading or internal mechanical damage.", metadata={"doc_id": "doc_4"}),
        Document(page_content="Low suction pressure may be caused by clogged filters or air leakage in the suction line.", metadata={"doc_id": "doc_5"}),
        Document(page_content="Frequent seal failures can result from improper installation or shaft misalignment.", metadata={"doc_id": "doc_6"}),
        Document(page_content="Increased vibration at specific frequencies often indicates imbalance in rotating parts.", metadata={"doc_id": "doc_7"}),
        Document(page_content="Overheating of motor windings can be caused by poor ventilation or electrical faults.", metadata={"doc_id": "doc_8"}),
        Document(page_content="Reduced flow rate may result from impeller wear or blockage in the system.", metadata={"doc_id": "doc_9"}),
        Document(page_content="Oil contamination in bearings can lead to increased friction and eventual failure.", metadata={"doc_id": "doc_10"}),
        Document(page_content="Cavitation noise and vibration occur due to low suction head or vapor formation in the fluid.", metadata={"doc_id": "doc_11"}),
        Document(page_content="Loose mounting bolts can cause excessive vibration and misalignment issues.", metadata={"doc_id": "doc_12"}),
    ]
